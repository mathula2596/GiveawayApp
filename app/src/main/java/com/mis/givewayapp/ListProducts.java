...
public class ListProducts extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(getString(R.string.app_name) + " - All Products");
        ...
        modalClass.getUserRole(value -> {
            ...
            if(userRole.equals("Seller"))
            {
                query = db.collection("Products").whereEqualTo("userId",
                        firebaseAuth.getCurrentUser().getUid()).orderBy("dateCreated",
            ...
            {
                //CardView cardView;
                query = db.collection("Products").orderBy("dateCreated",
                        Query.Direction.DESCENDING).get();
